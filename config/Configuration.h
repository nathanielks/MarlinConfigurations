...
#define STRING_CONFIG_H_AUTHOR                                                 \
  "(thisiskeithb, BIQU B1)" // Who made the changes.
...
#define G26_RETRACT_MULTIPLIER                                                 \
  4.0 // G26 Q (retraction) used by default between mesh test elements.
#endif
 ...
 * non-Latin characters. UNIFONT   - Lightweight font, no antialiasing. Supports
 * Latin Extended and non-Latin characters. HELVETICA - Lightweight font, no
 * antialiasing. Supports Basic Latin (0x0020-0x007F) and Latin-1 Supplement
 * (0x0080-0x00FF) characters only.
 */
...
#define NEOPIXEL_PIXELS                                                        \
  2 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is
    // disabled.)
// #define NEOPIXEL_IS_SEQUENTIAL        // Sequential display for temperature
